						...
						<table>
							<tr>
								...
								<td>
									...
									<div id='cssmenu'>
										<ul>
   											<li style="list-style: none;"><a href='logout.jsp'>Logout</a></li>
										</ul>
									</div>								
								</td>
							</tr>
			...
			<div class="span12">
				<div class="row">
					<div class="span12">
						<div class="main-titles lined">
							<h2 class="title"><span class="light">Best</span> <%=tag%> items</h2>
						</div>	
					</div>
				</div>
				...
				<%
					try{
			        	...
			        	String sqlQuery = "SELECT * FROM EcommerceTable WHERE tag1=? OR tag2=?";
