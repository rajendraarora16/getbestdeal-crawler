...
<head>
  ...
  <title>Your password successfully has been changed!</title>
      ...
      <div class="lock-container" style="width:50%;">
        <div class="panel panel-default text-center">
          <div class="panel-body">
           	...
           	<h5>Your password successfully have been changed. Please go back and <a href='login.jsp'>login</a> with your new password.</h5>
