							...
							<tr>
								...
								<td>
									...
									<div class="signin-container ">
										<button class="yt-uix-button yt-uix-button-size-default yt-uix-button-primary" type="button" onclick=";window.location.href=this.getAttribute('href');return false;" href="login.jsp" role="link" style="height:29px;">
											<span class="yt-uix-button-content">Create account or Sign in</span>
										</button>
									</div>									
								</td>
							</tr>
